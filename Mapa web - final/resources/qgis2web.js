...
map.getView().fit([-12570299.594308, 1602097.788342, -9904760.603654, 3699249.788342], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Infraestructura de gas en México</h2>';
        return titleElement;
    })(),
